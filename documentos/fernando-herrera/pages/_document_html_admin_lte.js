        ...
        return (
            <Html lang="en">
                <Head>
                    ...
                    {/* jQuery */}
                    <script src="/plugins/jquery/jquery.min.js" async />
                    {/* Bootstrap */}
                    <script src="/plugins/bootstrap/js/bootstrap.bundle.min.js"async />
                    {/* AdminLTE */}
                    <script src="/dist/js/adminlte.js" async />

                    {/* OPTIONAL SCRIPTS  */}
                    <script src="/plugins/chart.js/Chart.min.js" async />
                    {/* AdminLTE for demo purposes */}
                    <script src="/dist/js/demo.js" async />
                    {/* AdminLTE dashboard demo (This is only for demo purposes) */}
                    <script src="/dist/js/pages/dashboard3.js" async />
                </Head>
